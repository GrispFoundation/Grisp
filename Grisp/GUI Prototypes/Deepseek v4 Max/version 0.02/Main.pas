...
begin
  ...
  // ★ Rechterpaneel — expliciete Top-positionering
  ...
  // ★ Linkerpaneel — expliciete Top-positionering
...
// ★ Herbereken linker paneel layout — nodig bij resize
...
// ★ Herbereken rechter paneel layout
...
// ═══════════════════════════════════════════════════════════════════
//  Chat: bericht toevoegen  ★ alBottom voor correcte volgorde
// ═══════════════════════════════════════════════════════════════════
...
begin
  ...
  // ★ alBottom: nieuwste bericht onderaan, oudere schuiven omhoog
  MsgPanel.Align := alBottom;
  MsgPanel.AlignWithMargins := True;
  MsgPanel.Margins.SetBounds(16, 4, 16, 4);
