        ...
        try
            ...
            try
                ...
                try
                    ...
                    { Construct the simulated peer input. ExecuteRound is the
                      coordinator-level operation: it authenticates/ingests the
                      inputs for its current round, selects the best candidate,
                      and materializes the candidate artifact. Do not first send
                      the same input through peer_message, because that command
                      already ingests it and would cause a duplicate submission
                      with a later round ID. }
