...
const
  ...
  // ══════════════════════════════════════════════════════════════
  //  TRUECOLOR palette — "Electric Blue"
  //  Geen groencomponent in de accentkleuren meer.
  // ══════════════════════════════════════════════════════════════

  // ── Foreground ──
  FG_ACCENT = ESC + '[38;2;90;169;255m';    // #5AA9FF  elektrisch blauw
  FG_BORDER = ESC + '[38;2;46;107;184m';    // #2E6BB8  gedempt blauw
  FG_USER   = ESC + '[38;2;122;180;255m';   // #7AB4FF  licht blauw
  FG_TEXT   = ESC + '[38;2;232;240;255m';   // #E8F0FF  koel wit
  FG_GRAY   = ESC + '[38;2;150;170;200m';   // #96AAC8  secundair
  FG_DGRAY  = ESC + '[38;2;90;110;140m';    // #5A6E8C  hints
  FG_GREEN  = ESC + '[38;2;74;222;128m';    // #4ADE80  done
  FG_AMBER  = ESC + '[38;2;251;191;36m';    // #FBBF24  running
  FG_SLATE  = ESC + '[38;2;120;150;200m';   // #7896C8  accentbalk

  // ── Backgrounds ──
  BG_MAIN   = ESC + '[48;2;10;22;40m';      // #0A1628  diep marineblauw
  BG_PANEL  = ESC + '[48;2;15;32;56m';      // #0F2038  paneel
  BG_BAR    = ESC + '[48;2;13;27;48m';      // #0D1B30  top/status balk
  BG_INPUT  = ESC + '[48;2;15;32;56m';      // #0F2038  inputveld
  BG_USER   = ESC + '[48;2;30;74;138m';     // #1E4A8A  user bubbel
  BG_AI     = ESC + '[48;2;42;63;95m';      // #2A3F5F  AI bubbel
...
begin
  ...
  try
    AddLine(BG_PANEL + FG_ACCENT + BOLD + ' RESOURCES');
    ...
    begin
      ...
      if T.Perm = '' then
        Buf := BG_PANEL + FG_ACCENT + StringOfChar(' ', Indent)
             + '▸ ' + BOLD + T.Name
      else
      begin
        if T.Perm = 'RWX' then PermCol := FG_ACCENT
    ...
    AddLine(BG_PANEL + FG_ACCENT + BOLD + ' SESSIONS');
    AddLine(BG_PANEL + FG_BORDER + ' ' + StringOfChar('─', LEFT_W - 2));
    ...
    begin
      ...
      if I = ActiveSessionIdx then
        Buf := BG_PANEL + FG_ACCENT + BOLD + ' ▸ ' + S.Name
      else
...
begin
  L := TList<string>.Create;
  try
    AddLine(BG_MAIN + ' ' + FG_ACCENT + BOLD + 'CHAT'
          + RST + BG_MAIN + FG_GRAY + ' · '
    ...
    begin
      AddLine(BG_MAIN + ' ' + FG_BORDER + StringOfChar('─', CenterW - 2));
      AddLine(BG_MAIN + ' ' + FG_ACCENT + BOLD + 'PLAN'
    ...
    begin
      AddLine(BG_MAIN + ' ' + FG_BORDER + StringOfChar('─', CenterW - 2));
      AddLine(BG_MAIN + ' ' + FG_ACCENT + BOLD + 'THINK'
...
begin
  ...
  try
    ...
    Line := BG_BAR + ' ' + FG_ACCENT + BOLD + '◈ ' + APP_NAME
    ...
    InputRow := ScreenH - 3;
    Line := BG_INPUT + ' ' + FG_ACCENT + BOLD + '>' + RST + BG_INPUT
          + FG_TEXT + ' ' + InputBuf;
    ...
    Line := BG_BAR + ' ' + FG_GREEN + '● Connected' + RST + BG_BAR
          ...
          + ' ' + FG_DGRAY + '│' + RST + BG_BAR
          + ' ' + FG_GRAY + 'Permissions:' + FG_ACCENT + ' RWX'
          + ' ' + FG_DGRAY + '│' + RST + BG_BAR
