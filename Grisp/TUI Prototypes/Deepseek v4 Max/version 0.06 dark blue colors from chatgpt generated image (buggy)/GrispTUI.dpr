...
const
  ...
  // ══════════════════════════════════════════════════════════════
  //  DEEP SPACE palette
  //  Match met derde referentie-afbeelding:
  //  donkerder, contrastrijker, vivid cyaan-blauw accenten
  // ══════════════════════════════════════════════════════════════

  // ── Primary accents ──
  FG_CYAN   = ESC + '[38;2;77;168;218m';    // #4DA8DA helder cyaan-blauw
  FG_BLUE   = ESC + '[38;2;59;130;246m';    // #3B82F6 vivid blauw
  FG_BRIGHT = ESC + '[38;2;96;165;250m';    // #60A5FA fel blauw

  // ── Structural ──
  FG_BORDER = ESC + '[38;2;46;82;128m';     // #2E5280 zichtbare rand
  FG_USER   = ESC + '[38;2;147;197;253m';   // #93C5FD user label
  FG_TEXT   = ESC + '[38;2;241;245;249m';   // #F1F5F9 koel wit
  FG_GRAY   = ESC + '[38;2;148;163;184m';   // #94A3B8 muted slate
  FG_DGRAY  = ESC + '[38;2;100;116;139m';   // #64748B dimmer slate
  FG_GREEN  = ESC + '[38;2;34;197;94m';     // #22C55E success
  FG_AMBER  = ESC + '[38;2;245;158;11m';    // #F59E0B running
  FG_SLATE  = ESC + '[38;2;96;165;250m';    // #60A5FA accentbalk

  // ── Backgrounds (dieper dan v0.05) ──
  BG_MAIN   = ESC + '[48;2;10;15;30m';      // #0A0F1E diep ruimteblauw
  BG_PANEL  = ESC + '[48;2;15;24;40m';      // #0F1828 paneel
  BG_BAR    = ESC + '[48;2;12;20;32m';      // #0C1420 top/status balk
  BG_INPUT  = ESC + '[48;2;15;24;40m';      // #0F1828 inputveld
  BG_USER   = ESC + '[48;2;30;58;95m';      // #1E3A5F user bubbel
  BG_AI     = ESC + '[48;2;22;36;60m';      // #16243C AI bubbel
  BG_HEAD   = ESC + '[48;2;22;36;60m';      // #16243C header-achtergrond
...
begin
  ...
  try
    // Header met BG_HEAD achtergrond voor "card"-gevoel
    AddLine(BG_HEAD + FG_CYAN + BOLD + ' ▾ RESOURCES'
          + RST + BG_HEAD + StringOfChar(' ', LEFT_W - 12));
    ...
    // SESSIONS header met BG_HEAD
    AddLine(BG_HEAD + FG_CYAN + BOLD + ' ▾ SESSIONS'
          + RST + BG_HEAD + StringOfChar(' ', LEFT_W - 11));
    AddLine(BG_PANEL + FG_BORDER + ' ' + StringOfChar('─', LEFT_W - 2));
    ...
    begin
      ...
      begin
        // Actief: BG_HEAD met fel blauwe tekst en linker accent
        Buf := BG_HEAD + FG_BRIGHT + BOLD + ' ▌' + S.Name;
        AddLine(Buf);
        AddLine(BG_HEAD + FG_GRAY + '   ' + S.Meta
              + RST + BG_HEAD + StringOfChar(' ', LEFT_W - 16));
      end
      else
      begin
        AddLine(BG_PANEL + FG_TEXT + ' ▸ ' + S.Name);
...
begin
  L := TList<string>.Create;
  try
    // CHAT header met BG_HEAD
    AddLine(BG_HEAD + ' ' + FG_CYAN + BOLD + '◆ CHAT'
          + RST + BG_HEAD + FG_GRAY + ' · '
          + FG_TEXT + CurrentSession
          + RST + BG_HEAD + StringOfChar(' ', 4));
    ...
    begin
      AddLine(BG_MAIN + ' ' + FG_BORDER + StringOfChar('─', CenterW - 2));
      AddLine(BG_HEAD + ' ' + FG_CYAN + BOLD + '◆ PLAN'
            + RST + BG_HEAD + FG_DGRAY + '   [F4 to hide]'
            + RST + BG_HEAD + StringOfChar(' ', 4));
    ...
    begin
      AddLine(BG_MAIN + ' ' + FG_BORDER + StringOfChar('─', CenterW - 2));
      AddLine(BG_HEAD + ' ' + FG_CYAN + BOLD + '◆ THINK'
            + RST + BG_HEAD + FG_DGRAY + '   [F3 to hide]'
            + RST + BG_HEAD + StringOfChar(' ', 4));
...
begin
  ...
  try
    ...
    // Topbar — logo in CYAN (match derde afbeelding)
    Line := BG_BAR + ' ' + FG_CYAN + BOLD + '◈ ' + APP_NAME
