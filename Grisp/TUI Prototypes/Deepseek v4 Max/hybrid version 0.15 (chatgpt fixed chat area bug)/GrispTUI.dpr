{ ============================================================================
  GRISP OS — Terminal UI  ·  v0.23
  ----------------------------------------------------------------------------
  Nieuw in v0.23
    • Geen periodieke full-refresh meer (was de bron van het knipperen)
    • T-joints op de input-divider lichten cyaan op bij hover/drag
    • Elke regel wordt met ESC[2K gewist vóór het schrijven (geen residu meer)
  ============================================================================ }
...
var
  ...
  begin
    ...
    begin
      ...
      { Hard-wrap a single token as well. This prevents URLs, hashes and
        other long tokens from escaping the chat column. }
    ...
    { Preserve explicit blank lines in multiline chat messages. }
    if not HadText then
      L.Add('');
  end;
...
begin
  ...
  try
    { A submitted message may contain LF because plain Enter is deliberately
      supported for multiline input. Never let that LF reach the terminal
      renderer as part of a visual line: split it into actual chat rows. }
...
{ ============================================================================
  SECTIE 16 — Hoofdlus (geen periodieke refresh meer)
  ============================================================================ }
