...
const
  ...
  // ══════════════════════════════════════════════════════════════
  //  STARFLEET CONSOLE palette
  //  Lichter, vrolijker, hoger contrast — Star Trek geïnspireerd
  // ══════════════════════════════════════════════════════════════

  // ── Primary accents ──
  FG_CYAN   = ESC + '[38;2;88;216;255m';    // #58D8FF holografisch cyaan
  FG_GOLD   = ESC + '[38;2;255;186;74m';    // #FFBA4A Starfleet goud
  FG_PURPLE = ESC + '[38;2;184;156;255m';   // #B89CFF violet accent

  // ── Structural ──
  FG_BORDER = ESC + '[38;2;106;155;208m';   // #6A9BD0 zichtbare rand
  FG_USER   = ESC + '[38;2;146;208;255m';   // #92D0FF licht blauw
  FG_TEXT   = ESC + '[38;2;255;255;255m';   // #FFFFFF puur wit
  FG_GRAY   = ESC + '[38;2;168;192;222m';   // #A8C0DE secundair
  FG_DGRAY  = ESC + '[38;2;108;134;168m';   // #6C86A8 hints
  FG_GREEN  = ESC + '[38;2;94;232;136m';    // #5EE888 done
  FG_AMBER  = ESC + '[38;2;255;186;74m';    // #FFBA4A running
  FG_SLATE  = ESC + '[38;2;168;200;240m';   // #A8C8F0 accentbalk

  // ── Backgrounds (lichter dan v0.04) ──
  BG_MAIN   = ESC + '[48;2;14;35;64m';      // #0E2340 diep navy
  BG_PANEL  = ESC + '[48;2;22;50;86m';      // #163256 paneel
  BG_BAR    = ESC + '[48;2;26;58;98m';      // #1A3A62 top/status balk
  BG_INPUT  = ESC + '[48;2;22;50;86m';      // #163256 inputveld
  BG_USER   = ESC + '[48;2;34;104;176m';    // #2268B0 user bubbel
  BG_AI     = ESC + '[48;2;46;72;112m';     // #2E4870 AI bubbel
...
// ═══════════════════════════════════════════════════════════════════
//  Render: linkerpaneel  ── met GOUDEN sectiekoppen en ◢ iconen
// ═══════════════════════════════════════════════════════════════════
...
begin
  ...
  try
    // Gouden RESOURCES kop met ◢ icoon
...
// ═══════════════════════════════════════════════════════════════════
//  Render: chatpaneel  ── CYAN chat, GOUD plan, VIOLET think
// ═══════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════
//  Render: complete frame  ── GOUDEN logo in topbar
// ═══════════════════════════════════════════════════════════════════
