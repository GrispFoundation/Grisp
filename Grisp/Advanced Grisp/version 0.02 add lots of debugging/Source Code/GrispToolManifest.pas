...
uses
  SysUtils, Classes, Generics.Collections, System.IOUtils, GrispMarkerParser;
...
begin
  ...
  begin
    repeat
      ...
      // Read as raw bytes and decode manually
...
function TToolManifestRegistry.GetToolNames: string;
var
  s: string;
begin
  Result := '';
  for s in FManifests.Keys do
  begin
...
function TToolManifestRegistry.GetToolCount: Integer;
begin
  Result := FManifests.Count;
end;
